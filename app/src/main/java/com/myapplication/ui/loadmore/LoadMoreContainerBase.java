...
public abstract class LoadMoreContainerBase extends LinearLayout implements LoadMoreContainer {
    ...
    protected void onFinishInflate() {
        ...
        mAbsListView = retrieveAbsListView(); //构造absListView ,在子类实现
        init();
    }
    ...
    public void useDefaultFooter() {
        ...
        setLoadMoreView(footerView);//设置加载更多布局
        setLoadMoreUIHandler(footerView);//只要实现LoadMoreUIHandler，就可以
    }
