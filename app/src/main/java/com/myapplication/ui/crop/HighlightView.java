...
package com.myapplication.ui.crop;
...
class HighlightView {
    ...
    private final Paint outsidePaint = new Paint();  //底部画布颜色
    private final Paint outlinePaint = new Paint(); //框的颜色
    private final Paint handlePaint = new Paint();  //点的颜色

    private View viewContext; // View displaying image
    private boolean showThirds;
    private boolean showCircle;
    private int highlightColor; //框的颜色
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean maintainAspectRatio) {
        ...
        outlinePaint.setStyle(Paint.Style.STROKE);//空心
        outlinePaint.setAntiAlias(true);
        outlineWidth = dpToPx(OUTLINE_DP);

        handlePaint.setColor(highlightColor);
        handlePaint.setStyle(Paint.Style.FILL);//实心
