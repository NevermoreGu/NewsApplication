...
public abstract class BaseAbsListFragment<T1 extends Entity, T2 extends Entity, T3 extends AbsListView>
...
//                        StringUtils.getCurTimeStr());
    ...
    protected Callback<ResponseBody> callback = new Callback<ResponseBody>() {
        @Override
...
//                        StringUtils.getCurTimeStr());
            ...
            if (isAdded()) {
                executeParserTask(response.body().toString());
            }
        }
