...
import com.myapplication.app.lifecycle.IComponentContainer;
import com.myapplication.app.lifecycle.LifeCycleComponent;
import com.myapplication.app.lifecycle.LifeCycleComponentManager;
import com.myapplication.interf.BaseFragmentInterface;
...
public class BaseFragment extends Fragment implements BaseFragmentInterface, View.OnClickListener, IComponentContainer {
...
//                BitmapFactory.decodeResource(getResources(), R.mipmap.device));
...
//        sinaContent.setShareImage(new UMImage(getActivity(), R.mipmap.actionbar_back_indicator));
...
//        TDevice.changeWindowAlpha(getActivity(), 0.4f);
//        CustomShareBoard shareBoard = new CustomShareBoard(getActivity());
//        shareBoard.showAtLocation(getActivity().getWindow().getDecorView(), Gravity.CENTER, 0, 0);
//    }
