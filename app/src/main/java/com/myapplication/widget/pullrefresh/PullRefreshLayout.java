package com.myapplication.widget.pullrefresh;
...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.refresh_PullRefreshLayout_refreshType, STYLE_MATERIAL);//STYLE_MATERIAL默认值
        ...
        mDecelerateInterpolator = new DecelerateInterpolator(DECELERATE_INTERPOLATION_FACTOR);//减速运动
...
//        mRefreshView.bringToFront();
        mTarget.offsetTopAndBottom(offset);//public void offsetLeftAndRight(int offset)用于左右移动方法或public void offsetTopAndBottom(int offset)用于上下移动
        mCurrentOffsetTop = mTarget.getTop();
