package com.myapplication.widget.Smarttablayout;
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        textSelectedColor = a.getColorStateList(
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == viewPager.getCurrentItem()) {
                ...
                ((TextView) tabView).setTextColor(textSelectedColor);
            }
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0, size = tabStrip.getChildCount(); i < size; i++) {
                if (position == i) {
                    ...
                    ((TextView) tabStrip.getChildAt(i)).setTextColor(textSelectedColor);
                } else {
                    ((TextView) tabStrip.getChildAt(i)).setTextColor(tabViewTextColors);
                }
            }
