...
public class PagerTabStrip extends HorizontalScrollView implements
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray attrsTypedArray = context.obtainStyledAttributes(attrs,
                    R.styleable.PagerTabStrip);
            if (attrsTypedArray != null) {
                allowWidthFull = attrsTypedArray.getBoolean(
                        R.styleable.PagerTabStrip_allowWidthFull, false);
                slidingBlockDrawable = attrsTypedArray
                        .getDrawable(R.styleable.PagerTabStrip_slidingBlock);
                disableViewPager = attrsTypedArray.getBoolean(
                        R.styleable.PagerTabStrip_disableViewPager,
                        false);
