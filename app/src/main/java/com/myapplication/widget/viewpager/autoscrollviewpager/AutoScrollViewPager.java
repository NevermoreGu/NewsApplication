...
public class AutoScrollViewPager extends ViewPager {
    ...
    private PagerAdapter otherWrapperPagerAdapter;
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        otherWrapperPagerAdapter = (wrappedPagerAdapter == null) ? null : new AutoScrollPagerAdapter(adapter);
        super.setAdapter(otherWrapperPagerAdapter);
...
//        }
    ...
    public int getCurrentItem() {
        ...
        if (wrappedPagerAdapter != null && wrappedPagerAdapter.getCount() > 1) {
            ...
            } else if (curr == otherWrapperPagerAdapter.getCount() - 1) {
                curr = 0;
            } else {
                curr = curr - 1;
            }
    ...
    private int getCountOfWrapper() {
        if (otherWrapperPagerAdapter != null) {
            return otherWrapperPagerAdapter.getCount();
        }
        return 0;
    }
